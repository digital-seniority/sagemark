...
The structure that `C:/Users/stone/Code/sagemark/apps/seo/builds/seo-creator/STATE.md` should always follow.
Bootstrap from this on first run; update in place each subsequent run.
...
**Last updated:** YYYY-MM-DD HH:MM (Run #NNN)
**Current build phase:** Phase N (<phase name>)
**Phase progress:** X / Y engineering PRs merged · Z / N non-engineering deliverables

## Currently in flight

- PR <id>: <description> — STATUS (IN_FLIGHT / INTERRUPTED / APPROVED_NOT_COMMITTED / PR_CREATED / PREVIEW_FAILED) — <one-line note>
...
- <blocker> — <what's needed and from whom>

## Recent learnings (last 5 — older entries roll into run-log)

- (Run #NNN) <learning> — actionable detail
...
## Phase 0 — Foundations PR map (synced from the RFC)
...
## Phase 1 — Pilot PR map (synced from the RFC)
...
*Bootstrap state · Phase 0 · 23 PRs total · all NOT_STARTED · ready for Run #001*
```
